...
$(function(){$("#my-menu").mmenu({navbar:{title:!1}}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".photos").slick({dots:!1,arrows:!0,accessibility:!1,infinite:!0,autoplay:!0,speed:1100,mobileFirst:!0,nextArrow:'<div style="display: block;"><i class="fa fa-angle-right slick-next"></i></div>',prevArrow:'<div style="display: block;"><i class="fa fa-angle-left slick-prev"></i></div>'}),$(".tours").slick({dots:!1,arrows:!1,accessibility:!1,infinite:!0,autoplay:!0,speed:1100,fade:!0,mobileFirst:!0}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".back-to-top").addClass("active"):$(".back-to-top").removeClass("active")}),$(".back-to-top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});